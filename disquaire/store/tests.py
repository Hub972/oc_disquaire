...
class BookingPageTestCase(TestCase):
    ...
    def test_booking_belongs_contact(self):
        ...
        booking = Booking.objects.get(contact=id_name)
        booking_cntct_id = booking.contact_id
        self.assertEqual(booking_cntct_id, id_name )
    ...
    def test_booking_belongs_album(self):
        ...
        booking = Booking.objects.get(contact=album_id)
        booking_alb_id = booking.album_id
        self.assertEqual(booking_alb_id, album_id )
    ...
    def test_album_available_after_booking(self):
        ...
        available = self.album.available
